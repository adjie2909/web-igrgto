...
<head>
    ...
    <style>
        ...
        .badge-sjm { background:#fef9c3; color:#854d0e; }
        .badge-sam { background:#ede9fe; color:#5b21b6; }
        .badge-sm { background:#dcfce7; color:#166534; }
        .badge-pga { background:#fce7f3; color:#9d174d; }

        /* FORM GRID */
        .grid-2 {
            display:grid;
            grid-template-columns:1fr 1fr;
            gap:20px; /* dari 15 → lebih lega */
        }
        ...
        .aksi {
            display:flex;
            gap:8px;
            flex-wrap: wrap; /* biar ga kepanjangan */
        }
        /* MODAL */
        .modal {
            display:none;
