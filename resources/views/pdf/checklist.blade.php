...
<body>
    ...
    <table class="meta-table">
        <tr><td class="meta-label">Nomor</td><td class="meta-colon">:</td><td><strong>{{ $req->nomor_dokumen }}</strong></td></tr>
        ...
        <tr><td class="meta-label">Tanggal</td><td class="meta-colon">:</td><td>{{ date('d-m-Y', strtotime($req->tanggal_request)) }}</td></tr>
    </table>
