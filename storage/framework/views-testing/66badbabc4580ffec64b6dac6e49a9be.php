            ...
            <table role="presentation" width="640" cellspacing="0" cellpadding="0" style="width:640px; max-width:640px; background:#ffffff; border:1px solid #e5e7eb; border-radius:10px; overflow:hidden;">
                        ...
                        <?php if($type === 'request'): ?>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="border-collapse:collapse; font-size:14px;">
                                <tr>
                                    ...
                                    <td style="padding:10px 0; border-bottom:1px solid #e5e7eb; font-weight:600;"><?php echo e($requestData->nomor_dokumen ?? '-'); ?></td>
                                </tr>
                                <tr>
                                    <td style="padding:10px 0; color:#6b7280; border-bottom:1px solid #e5e7eb;">Tanggal Request</td>
                                    <td style="padding:10px 0; border-bottom:1px solid #e5e7eb;"><?php echo e($requestData->tanggal_request ?? '-'); ?></td>
                                </tr>
                                <tr>
                                    <td style="padding:10px 0; color:#6b7280; border-bottom:1px solid #e5e7eb;">Pemohon</td>
                                    <td style="padding:10px 0; border-bottom:1px solid #e5e7eb;"><?php echo e($requesterName); ?></td>
                                </tr>
                                <tr>
                                    <td style="padding:10px 0; color:#6b7280; border-bottom:1px solid #e5e7eb;">Divisi</td>
                                    <td style="padding:10px 0; border-bottom:1px solid #e5e7eb;"><?php echo e($divisionName); ?></td>
                                </tr>
                                <tr>
                                    <td style="padding:10px 0; color:#6b7280;">Level Approval</td>
                                    <td style="padding:10px 0; font-weight:600;"><?php echo e($targetRole ?? '-'); ?></td>
                                </tr>
                            </table>
                        <?php elseif($type === 'pga'): ?>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="border-collapse:collapse; font-size:14px;">
                                ...
                                <tr>
                                    ...
                                    <td style="padding:10px 0; border-bottom:1px solid #e5e7eb; font-weight:600;"><?php echo e($requestStatusLabel); ?></td>
                                </tr>
                                <tr>
                                    <td style="padding:10px 0; color:#6b7280;">Tujuan</td>
                                    <td style="padding:10px 0; font-weight:600;"><?php echo e($targetRole ?? 'PGA'); ?></td>
                                </tr>
                            </table>
                        <?php elseif($type === 'ticket'): ?>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="border-collapse:collapse; font-size:14px;">
                                <tr>
                                    ...
                                    <td style="padding:10px 0; border-bottom:1px solid #e5e7eb; font-weight:600;">#<?php echo e($ticketData->id ?? '-'); ?></td>
                                </tr>
                                <tr>
                                    <td style="padding:10px 0; color:#6b7280; border-bottom:1px solid #e5e7eb;">Judul</td>
                                    <td style="padding:10px 0; border-bottom:1px solid #e5e7eb;"><?php echo e($ticketData->judul ?? '-'); ?></td>
                                </tr>
                                <tr>
                                    <td style="padding:10px 0; color:#6b7280; border-bottom:1px solid #e5e7eb;">Status</td>
                                    <td style="padding:10px 0; border-bottom:1px solid #e5e7eb;"><?php echo e($ticketStatus); ?></td>
                                </tr>
                                <tr>
                                    <td style="padding:10px 0; color:#6b7280; border-bottom:1px solid #e5e7eb;">Penanggung Jawab</td>
                                    <td style="padding:10px 0; border-bottom:1px solid #e5e7eb;"><?php echo e($ticketData->current_handler ?? '-'); ?></td>
                                </tr>
                                <tr>
                                    <td style="padding:10px 0; color:#6b7280; border-bottom:1px solid #e5e7eb;">Divisi</td>
                                    <td style="padding:10px 0; border-bottom:1px solid #e5e7eb;"><?php echo e($divisionName); ?></td>
                                ...
                                <tr>
                                    ...
                                    <td style="padding:10px 0; font-weight:600;"><?php echo e($ticketEventLabel); ?></td>
                                </tr>
                            </table>
                        <?php elseif($type === 'stock'): ?>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="border-collapse:collapse; font-size:14px;">
                                <tr>
                                    ...
                                    <td style="padding:10px 0; border-bottom:1px solid #e5e7eb; font-weight:600;"><?php echo e($payload['stock_item_name'] ?? '-'); ?></td>
                                </tr>
                                <tr>
                                    <td style="padding:10px 0; color:#6b7280;">Stok Tersedia</td>
                                    <td style="padding:10px 0; font-weight:600;">
                                        <?php echo e($payload['stock_available'] ?? 0); ?> <?php echo e($payload['stock_unit'] ?? ''); ?>
                ...
                <tr>
                    <td style="padding:14px 24px; background:#f8fafc; border-top:1px solid #e5e7eb; font-size:12px; color:#64748b;">
                        &copy; <?php echo e(date('Y')); ?> INDGROSIR-GORONTALO
                    </td>
                </tr>
            </table>
        </td>
...
<?php /**PATH C:\laragon\www\web-igrgto\resources\views/emails/system_notification.blade.php ENDPATH**/ ?>